...
func (mw loggingMiddleware) Login(username, password string) (user users.User, token string, err error) {
...
func (mw loggingMiddleware) Register(username, password, email, first, last string) (string, string, error) {
	defer func(begin time.Time) {
		mw.logger.Log(
			"method", "Register",
			"username", username,
...
func (s *instrumentingService) Login(username, password string) (users.User, string, error) {
	defer func(begin time.Time) {
...
func (s *instrumentingService) Register(username, password, email, first, last string) (string, string, error) {
	defer func(begin time.Time) {
